...
/**
 * Created by Bogdan Cristian Vlad on 15-Dec-17.
 */
...
public class Constants {
    ...
    public static final int APP_NOTIFICATION_ID = 7;
    public static final int LOCATION_NOTIFICATION_ID = 10;
    public static final int REQ_PERMISSION = 3;
}
